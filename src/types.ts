...
export type Candidate = { field: keyof CaseData; value: string; source: Source; autoFill?: boolean; reason?: string; requires?: Partial<Pick<CaseData, "applicantName" | "respondentName">> };
export type IdentityTarget = "auto" | "applicant" | "respondent";
